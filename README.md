...
I am a recent computer science graduate from the University of Southern California. I enjoy creating technology that makes everyday life simpler, more efficient, and amusing. Currently, I am based out of New York.

I am interested in trading systems and zero-knowledge proofs.
...
- I used to love [Neovim](https://neovim.io/), but now I just use VSCodeVim. You can find/test out my old configuration [here](https://github.com/lognorman20/nvimconfig). You can also see my `.vimrc` along with other configurations [here](https://github.com/lognorman20/dotfiles).
